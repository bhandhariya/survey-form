...
const AppRoutes: Routes = [
  ...
  { path : 'survey', component : SurveyComponent,canActivate:[LoginService] },
  { path : '**', redirectTo :'', pathMatch : 'full'}
];

@NgModule({
  declarations: [AdminComponent, HomeComponent, UserComponent,FirstSurveyComponent,SurveyComponent],
  imports: [
